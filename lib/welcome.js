...
module.exports = welcome = async (tobz, event) => {
    ...
    try {
        if (event.action == 'add' && isWelkom) {
            ...
            const capt = `Halo Su...@${event.who.replace('@c.us', '')} 👋\nSelamat datang di *Grup ${name}*\n═══════════════════\nSelamat datang,semoga betah dan tak hanya singgah karena ku telah lelah memilih memilah dan akhirnya salah dan patah.\n═══════════════════\n`
